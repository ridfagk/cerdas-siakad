...
/**
 * MentorSearch represents the model behind the search form of `backend\models\Pegawai`.
 */
class MentorSearch extends Pegawai
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = Pegawai::find()->where(['jabatan'=>'Mentor']);
